...
import {AiFillCheckSquare, AiOutlineArrowDown, AiOutlineArrowUp,} from "react-icons/ai";
    ...
    return (
        <>
            <div
                ...
                className={clsx("bg-[#fff] flex flex-col touch-manipulation p-2 rounded-[4px] shadow-sm hover:bg-gray-300 my-1 mx-1 transition duration-100 ease-in delay-[0ms] select-none  ", {"rotate-[4deg] scale-[1.1] ": snapshot.isDragging})}
            >
